    ...
    <div className="bg-background-light min-h-screen flex flex-col items-center justify-center p-4 sm:p-8 font-sans">
      ...
      <div className="w-full max-w-[560px] mb-8 mt-4">
        <div className="flex items-center justify-between relative px-2">
          ...
          <div className="flex flex-col items-center gap-2 opacity-50">
            ...
            <span className="text-xs font-medium text-slate-500">Verify Email</span>
          </div>
      ...
      <main className="w-full max-w-[560px] bg-white rounded-xl shadow-lg overflow-hidden border border-slate-100">
        <header className="bg-primary px-8 py-6 text-center">
          <h1 className="text-white text-2xl font-bold tracking-tight">Register Your Company</h1>
          <p className="text-blue-100 text-sm mt-1 opacity-90">Start hiring smarter with our AI platform</p>
        </header>
      ...
      <footer className="mt-8 text-center pb-8">
        <p className="text-sm text-slate-600">
          ...
          <Link href="/auth/login" className="font-semibold text-primary hover:text-primary-hover hover:underline ml-1 transition-colors">
            Sign In
          </Link>
        </p>
      </footer>
