          ...
          <div className="flex flex-col gap-4 overflow-y-auto pr-1">
            {[
              ...
              >
                ...
                {/* Dynamically applying Tailwind classes for badges */}
                <span
                  className={`text-xs font-medium px-2 py-1 rounded 
                  ${user.color === "orange" ? "bg-orange-50 text-orange-600" : ""}
                  ${user.color === "green" ? "bg-green-50 text-green-600" : ""}
                  ${user.color === "blue" ? "bg-blue-50 text-blue-600" : ""}
                `}
                >
                  {user.status}
                </span>
